...
---@param qtype 1 | 28
---@param callback fun(err?: luvit.Error, answers?: luvit.dns.AddressQueryAnswer[])|thread
---@overload fun(servers: luvit.dns.ServerAddress[], name: string, dnsclass: luvit.dns.dnsclass, qtype: 2, callback: fun(err?: luvit.Error, answers?: luvit.dns.NameServerQueryAnswer)|thread)
---@overload fun(servers: luvit.dns.ServerAddress[], name: string, dnsclass: luvit.dns.dnsclass, qtype: 5, callback: fun(err?: luvit.Error, answers?: luvit.dns.CanonicalNameQueryAnswer)|thread)
---@overload fun(servers: luvit.dns.ServerAddress[], name: string, dnsclass: luvit.dns.dnsclass, qtype: 12, callback: fun(err?: luvit.Error, answers?: luvit.dns.PointerQueryAnswer)|thread)
---@overload fun(servers: luvit.dns.ServerAddress[], name: string, dnsclass: luvit.dns.dnsclass, qtype: 15, callback: fun(err?: luvit.Error, answers?: luvit.dns.MailExchangeQueryAnswer)|thread)
---@overload fun(servers: luvit.dns.ServerAddress[], name: string, dnsclass: luvit.dns.dnsclass, qtype: 16, callback: fun(err?: luvit.Error, answers?: luvit.dns.TextQueryAnswer)|thread)
---@overload fun(servers: luvit.dns.ServerAddress[], name: string, dnsclass: luvit.dns.dnsclass, qtype: 33, callback: fun(err?: luvit.Error, answers?: luvit.dns.ServerQueryAnswer)|thread)
...
---@param name string
---@param callback fun(err?: luvit.Error, answers?: luvit.dns.ServerQueryAnswer[])|thread
function dns.resolveSrv(name, callback) end

---@param name string
---@param callback fun(err?: luvit.Error, answers?: luvit.dns.MailExchangeQueryAnswer[])|thread
function dns.resolveMx(name, callback) end

---@param name string
---@param callback fun(err?: luvit.Error, answers?: luvit.dns.NameServerQueryAnswer[])|thread
function dns.resolveNs(name, callback) end

---@param name string
---@param callback fun(err?: luvit.Error, answers?: luvit.dns.CanonicalNameQueryAnswer[])|thread
function dns.resolveCname(name, callback) end

---@param name string
---@param callback fun(err?: luvit.Error, answers?: luvit.dns.TextQueryAnswer[])|thread
